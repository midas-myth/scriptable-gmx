...
declare class ContactsGroup {
   ...
   */
  static all(
    containers: readonly ContactsContainer[]
...
declare var Location: {
  ...
  reverseGeocode(
    ...
    longitude: number,
    locale?: string
  ): Promise<Location.GeocodeSummary[]>;
};
